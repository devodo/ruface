...
/* I2C Interface 0 */
#define I2C0_CONSET   (*((volatile unsigned long *) 0xE001C000))
#define I2C0_STAT     (*((volatile unsigned long *) 0xE001C004))
#define I2C0_DAT      (*((volatile unsigned long *) 0xE001C008))
#define I2C0_ADR      (*((volatile unsigned long *) 0xE001C00C))
#define I2C0_SCLH     (*((volatile unsigned long *) 0xE001C010))
#define I2C0_SCLL     (*((volatile unsigned long *) 0xE001C014))
#define I2C0_CONCLR   (*((volatile unsigned long *) 0xE001C018))
...
/* I2C Interface 1 */
#define I2C1_CONSET      (*((volatile unsigned long *) 0xE005C000))
#define I2C1_STAT        (*((volatile unsigned long *) 0xE005C004))
#define I2C1_DAT         (*((volatile unsigned long *) 0xE005C008))
#define I2C1_ADR         (*((volatile unsigned long *) 0xE005C00C))
#define I2C1_SCLH        (*((volatile unsigned long *) 0xE005C010))
#define I2C1_SCLL        (*((volatile unsigned long *) 0xE005C014))
#define I2C1_CONCLR      (*((volatile unsigned long *) 0xE005C018))
